...
pub fn get_referrer_and_referrer_stats<'a>(
    ...
    let user_stats_discriminator = &UserStats::DISCRIMINATOR;
    let account_discriminator = array_ref![data, 0, 8];
...
pub fn get_high_leverage_mode_config<'a>(
    ...
    let high_leverage_mode_config_discriminator = &HighLeverageModeConfig::DISCRIMINATOR;
    let account_discriminator = array_ref![data, 0, 8];
...
pub fn get_revenue_share_escrow_account<'a>(
    ...
    let discriminator = &RevenueShareEscrow::DISCRIMINATOR;
